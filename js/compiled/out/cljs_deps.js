...
goog.addDependency("../we_color/views.js", ['we_color.views'], ['cljs.core', 'clojure.string', 're_frame.core']);
goog.addDependency("../we_color/format.js", ['we_color.format'], ['goog.string', 'cljs.core', 'goog.string.format']);
goog.addDependency("../we_color/db.js", ['we_color.db'], ['cljs.core']);
goog.addDependency("../we_color/parse.js", ['we_color.parse'], ['cljs.core', 'clojure.string']);
goog.addDependency("../we_color/handlers.js", ['we_color.handlers'], ['cljs.core', 'we_color.format', 'we_color.db', 're_frame.core', 'we_color.parse']);
goog.addDependency("../we_color/subs.js", ['we_color.subs'], ['cljs.core', 're_frame.core']);
goog.addDependency("../we_color/config.js", ['we_color.config'], ['cljs.core']);
goog.addDependency("../we_color/core.js", ['we_color.core'], ['we_color.views', 'reagent.core', 'cljs.core', 'we_color.handlers', 'we_color.subs', 'we_color.config', 're_frame.core']);
...
goog.addDependency("../figwheel/connect.js", ['figwheel.connect'], ['we_color.core', 'cljs.core', 'figwheel.client', 'figwheel.client.utils']);
