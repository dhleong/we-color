...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__20199){
...
return cljs.core.get_in.call(null,new_db,p1__20200_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__20201_SHARP_){
return cljs.core.get_in.call(null,db,p1__20201_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__20202__i < G__20202__a.length) {G__20202__a[G__20202__i] = arguments[G__20202__i + 2]; ++G__20202__i;}
  in_paths = new cljs.core.IndexedSeq(G__20202__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__20203){
var f = cljs.core.first(arglist__20203);
arglist__20203 = cljs.core.next(arglist__20203);
var out_path = cljs.core.first(arglist__20203);
var in_paths = cljs.core.rest(arglist__20203);
...
//# sourceMappingURL=middleware.js.map?rel=1463713697764