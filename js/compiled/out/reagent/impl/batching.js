...
var or__18443__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__18443__auto__)){
return or__18443__auto__;
} else {
var or__18443__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__18443__auto____$1)){
return or__18443__auto____$1;
} else {
var or__18443__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__18443__auto____$2)){
return or__18443__auto____$2;
} else {
var or__18443__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__18443__auto____$3)){
return or__18443__auto____$3;
} else {
...
var n__19358__auto__ = a.length;
var i = (0);
while(true){
if((i < n__19358__auto__)){
var c_19881 = (a[i]);
if(cljs.core.truth_((c_19881["cljsIsDirty"]))){
(c_19881["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__19049__auto__,writer__19050__auto__,opt__19051__auto__){
return cljs.core._write.call(null,writer__19050__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__19885 = c;
var G__19885__$1 = (((G__19885 == null))?null:(G__19885["props"]));
if((G__19885__$1 == null)){
return null;
} else {
return (G__19885__$1["argv"]);
}
});
...
var G__19887_19888 = (c["cljsRatom"]);
if((G__19887_19888 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__19887_19888);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1463713697063