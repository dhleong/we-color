...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__19049__auto__,writer__19050__auto__,opt__19051__auto__){
return cljs.core._write.call(null,writer__19050__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__18443__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__18443__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__18443__auto__)){
return or__18443__auto__;
} else {
...
var G__19945 = o;
(G__19945[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_19949 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_19949))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_19949)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__18431__auto__ = (node === document.activeElement);
if(and__18431__auto__){
var and__18431__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__18431__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__19952 = jsprops;
(G__19952["defaultValue"] = value);

(G__19952["onChange"] = ((function (G__19952,v,value,on_change){
return (function (p1__19950_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__19950_SHARP_);
});})(G__19952,v,value,on_change))
);
...
var vec__19954 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__19954,(0),null);
var id = cljs.core.nth.call(null,vec__19954,(1),null);
var class$ = cljs.core.nth.call(null,vec__19954,(2),null);
...
var temp__4659__auto__ = (function (){var G__19958 = cljs.core.meta.call(null,v);
if((G__19958 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__19958);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__19960_19961 = v;
var G__19960_19962__$1 = (((G__19960_19961 == null))?null:reagent.impl.template.key_from_vec.call(null,G__19960_19961));
if((G__19960_19962__$1 == null)){
} else {
(jsprops["key"] = G__19960_19962__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__19965 = cljs.core.meta.call(null,argv);
if((G__19965 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__19965);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__19966 = (((jsprops == null))?{}:jsprops);
(G__19966["key"] = key);
...
var G__19967 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__19967;
continue;
}
} else {
...
var n__19358__auto___19968 = a.length;
var i_19969 = (0);
while(true){
if((i_19969 < n__19358__auto___19968)){
(a[i_19969] = reagent.impl.template.as_element.call(null,(a[i_19969])));

var G__19970 = (i_19969 + (1));
i_19969 = G__19970;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19358__auto___19971 = a.length;
var i_19972 = (0);
while(true){
if((i_19972 < n__19358__auto___19971)){
var val_19973 = (a[i_19972]);
if((cljs.core.vector_QMARK_.call(null,val_19973)) && ((reagent.impl.template.key_from_vec.call(null,val_19973) == null))){
(o["no-key"] = true);
} else {
}

(a[i_19972] = reagent.impl.template.as_element.call(null,val_19973));

var G__19974 = (i_19972 + (1));
i_19972 = G__19974;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__18431__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__18431__auto__){
return (ctx["no-key"]);
} else {
return and__18431__auto__;
...
var G__19976 = (cljs.core.count.call(null,argv) - first_child);
switch (G__19976) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__19976){
...
//# sourceMappingURL=template.js.map?rel=1463713697317